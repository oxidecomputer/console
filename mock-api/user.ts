...
export const user1: Json<User> = {
  ...
  time_modified: '2024-01-01T00:00:00.000Z',
}
...
export const user2: Json<User> = {
  ...
  silo_id: defaultSilo.id,
  time_created: '2024-01-15T00:00:00.000Z',
  time_modified: '2024-01-15T00:00:00.000Z',
}
...
export const user3: Json<User> = {
  ...
  silo_id: defaultSilo.id,
  time_created: '2024-02-01T00:00:00.000Z',
  time_modified: '2024-02-01T00:00:00.000Z',
}
...
export const user4: Json<User> = {
  ...
  silo_id: defaultSilo.id,
  time_created: '2024-02-15T00:00:00.000Z',
  time_modified: '2024-02-15T00:00:00.000Z',
}
...
export const user5: Json<User> = {
  ...
  silo_id: defaultSilo.id,
  time_created: '2024-03-01T00:00:00.000Z',
  time_modified: '2024-03-01T00:00:00.000Z',
}
...
export const user6: Json<User> = {
  ...
  silo_id: defaultSilo.id,
  time_created: '2024-03-15T00:00:00.000Z',
  time_modified: '2024-03-15T00:00:00.000Z',
}
...
export const userKosman: Json<User> = {
  ...
  time_created: '2024-04-01T00:00:00.000Z',
  time_modified: '2024-04-01T00:00:00.000Z',
}
...
export const userAnscombe: Json<User> = {
  ...
  time_created: '2024-04-15T00:00:00.000Z',
  time_modified: '2024-04-15T00:00:00.000Z',
}
...
export const userAdorno: Json<User> = {
  ...
  time_created: '2024-05-01T00:00:00.000Z',
  time_modified: '2024-05-01T00:00:00.000Z',
}
...
export const userNoPools: Json<User> = {
  ...
  time_created: '2024-05-15T00:00:00.000Z',
  time_modified: '2024-05-15T00:00:00.000Z',
}
