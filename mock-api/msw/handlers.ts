...
export const handlers = makeHandlers({
  ...
  antiAffinityGroupMemberList: ({ path, query }) => {
    const project = lookup.project({ ...query })
    const antiAffinityGroup = lookup.affinityGroup({
      project: project.id,
      affinityGroup: path.antiAffinityGroup,
    })
  ...
  antiAffinityGroupMemberAffinityGroupAdd: NotImplemented,
  antiAffinityGroupMemberAffinityGroupDelete: NotImplemented,
