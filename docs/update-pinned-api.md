...
1. Update the generated API client by running `npm run gen-api`. This will automatically check out the omicron commit specified in `OMICRON_VERSION`. If you forget this step, a safety test in `app/api` will fail.
