...
const inputStyle = `
  ...
  indeterminate:bg-accent-secondary indeterminate:border-accent-secondary indeterminate:hover:border-accent hover:indeterminate:bg-accent-secondary-hover
`
