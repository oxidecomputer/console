...
export const colorPalette: ColorPalette = {
  ...
  green50: 'hsl(154, 64%, 98%)',
  green100: 'hsl(154, 64%, 96%)',
  green200: 'hsl(153, 64%, 89%)',
  green300: 'hsl(153, 62%, 82%)',
  green400: 'hsl(153, 63%, 69%)',
  green500: 'hsl(154, 63%, 56%)',
  green600: 'hsl(154, 50%, 50%)',
  green700: 'hsl(153, 50%, 42%)',
  green800: 'hsl(154, 50%, 34%)',
  green900: 'hsl(154, 50%, 27%)',
}
