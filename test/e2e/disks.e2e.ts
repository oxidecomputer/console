...
test.describe('Disk create', () => {
  ...
  test('from snapshot', async ({ page }) => {
    ...
    await page.getByPlaceholder('Select a snapshot or enter a snapshot name', { exact: true }).click()
  ...
  test('from image', async ({ page }) => {
    ...
    await page.getByPlaceholder('Select an image or enter an image name', { exact: true }).click()
