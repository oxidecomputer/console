...
export default function ProjectUsersAndGroupsPage() {
  const projectSelector = useProjectSelector()
  return (
    <>
      <PageHeader>
        <PageTitle icon={<Access24Icon />}>Users & Groups</PageTitle>
        <DocsPopover
          heading="access"
          icon={<Access16Icon />}
      ...
      <RouteTabs fullWidth>
        <Tab to={pb.projectUsersAndGroupsUsers(projectSelector)}>Users</Tab>
        <Tab to={pb.projectUsersAndGroupsGroups(projectSelector)}>Groups</Tab>
      </RouteTabs>
    </>
  )
}
