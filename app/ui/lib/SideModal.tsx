          ...
          <BaseDialog.Popup
            render={
              <m.div
                ...
                className="ox-side-modal bg-raise shadow-modal 600:w-lg pointer-events-auto fixed top-0 right-0 bottom-0 z-(--z-side-modal) m-0 flex w-full flex-col justify-between p-0"
              />
            }
          >
