...
yarn token-transformer --preserveRawValue $STYLES_PATH/tokens.json $TOKENS_PATH/main.json global,colors,main
yarn token-transformer --preserveRawValue $STYLES_PATH/tokens.json $TOKENS_PATH/operator-mode.json colors,main,operator-mode
